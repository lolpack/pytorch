...
def backward(tensors: _TensorOrTensorsOrGradEdge, grad_tensors: Optional[_TensorOrTensors] = ..., retain_graph: Optional[bool] = ..., create_graph: bool = ..., grad_variables: Optional[_TensorOrTensors] = ..., inputs: Optional[_TensorOrTensorsOrGradEdge] = ...) -> None:
...
def grad(outputs: _TensorOrTensorsOrGradEdge, inputs: _TensorOrTensorsOrGradEdge, grad_outputs: Optional[_TensorOrTensors] = ..., retain_graph: Optional[bool] = ..., create_graph: bool = ..., only_inputs: bool = ..., allow_unused: Optional[bool] = ..., is_grads_batched: bool = ..., materialize_grads: bool = ...) -> tuple[torch.Tensor, ...]:
