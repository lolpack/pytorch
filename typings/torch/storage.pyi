...
import threading
import torch
from typing import Any, Optional as _Optional, TYPE_CHECKING, TypeVar, Union
...
class _StorageBase:
    ...
    is_sparse_csr: _bool = ...
    device: torch.device
    _fake_device: _Optional[torch.device] = ...
    _checkpoint_offset: _Optional[int] = ...
    ...
    def copy_(self, source: T, non_blocking: _Optional[_bool] = ...) -> T:
        ...
    ...
    def type(self, dtype: _Optional[str] = ..., non_blocking: _bool = ...) -> Union[_StorageBase, TypedStorage]:
        ...
    
    def cuda(self, device=..., non_blocking=...) -> Union[_StorageBase, TypedStorage]:
    ...
    def hpu(self, device=..., non_blocking=...) -> Union[_StorageBase, TypedStorage]:
    ...
    def to(self, *, device: DeviceLikeType, non_blocking: _bool = ...): # -> Any | UntypedStorage:
        ...
    ...
    def is_pinned(self, device: Union[str, torch.device] = ...):
    ...
    def pin_memory(self, device: Union[str, torch.device] = ...):
...
class TypedStorage:
    ...
    def copy_(self, source: T, non_blocking: _Optional[bool] = ...): # -> Self:
        ...
    
    def nbytes(self): # -> int:
        ...
    
    def type(self, dtype: _Optional[str] = ..., non_blocking: bool = ...) -> Union[_StorageBase, TypedStorage, str]:
        ...
    ...
    def pin_memory(self, device: Union[str, torch.device] = ...): # -> Self:
