...
def make_module_path_relative(abs_path): # -> str:
    """
...
def trace_structured_artifact(name: str, encoding: str, payload_fn: Callable[[], Optional[Union[str, object]]] = ...) -> None:
    ...
