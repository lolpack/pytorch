...
class CUDAGraph(torch._C._CUDAGraph):
    ...
    """
    def __new__(cls, keep_graph=...): # -> Self:
        ...
    
    def capture_begin(self, pool=..., capture_error_mode=...): # -> None:
...
class graph:
    ...
    """
    default_capture_stream: typing.Optional[torch.cuda.Stream] = ...
    def __init__(self, cuda_graph, pool=..., stream=..., capture_error_mode: str = ...) -> None:
        ...
...
def make_graphed_callables(callables, sample_args, num_warmup_iters=..., allow_unused_input=..., pool=...): # -> tuple[Any, ...]:
