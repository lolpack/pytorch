...
from torch import device as _device, version as _version
from torch._utils import _LazySeedTracker, _dummy_type, classproperty
from . import amp, gds, jiterator, nvtx, profiler, sparse, tunable
...
if not _version.hip:
    ...
    class _amdsmi_cdll_hook:
        ...
        def hooked_CDLL(self, name: Union[str, Path, None], *args: Any, **kwargs: Any) -> ctypes.CDLL:
            ...
...
_cached_device_count: Optional[int] = ...
