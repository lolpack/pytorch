...
class OnnxRegistry:
    ...
    def register_op(self, function: onnxscript.OnnxFunction | onnxscript.TracedOnnxFunction, namespace: str, op_name: str, overload: str | None = ..., is_complex: bool = ...) -> None:
    ...
    def get_op_functions(self, namespace: str, op_name: str, overload: str | None = ...) -> list[registration.ONNXFunction] | None:
    ...
    def is_registered_op(self, namespace: str, op_name: str, overload: str | None = ...) -> bool:
...
@deprecated("torch.onnx.dynamo_export is deprecated since 2.7.0. Please use torch.onnx.export(..., dynamo=True) instead.", category=None)
class ExportOptions:
    ...
    """
    def __init__(self, *, dynamic_shapes: bool | None = ..., fake_context: ONNXFakeContext | None = ..., onnx_registry: OnnxRegistry | None = ...) -> None:
        ...
...
def enable_fake_mode(): # -> Generator[ONNXFakeContext, Any, None]:
...
class ONNXRuntimeOptions:
    ...
    def __init__(self, *, session_options: Sequence[onnxruntime.SessionOptions] | None = ..., execution_providers: Sequence[str | tuple[str, dict[Any, Any]]] | None = ..., execution_provider_options: Sequence[dict[Any, Any]] | None = ...) -> None:
        ...
...
class FXGraphExtractor(abc.ABC):
    ...
    @abc.abstractmethod
    def pre_export_passes(self, options: ResolvedExportOptions, original_model: torch.nn.Module | Callable, fx_module: torch.fx.GraphModule, fx_module_args: Sequence[Any]): # -> None:
...
def common_pre_export_passes(options: ResolvedExportOptions, original_model: torch.nn.Module | Callable, fx_module: torch.fx.GraphModule, fx_module_args: Sequence[Any]): # -> GraphModule:
    ...
