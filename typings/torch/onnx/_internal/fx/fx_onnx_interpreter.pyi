...
if TYPE_CHECKING:
    ...
def filter_incompatible_and_dtype_convert_kwargs(kwargs): # -> dict[Any, Any]:
...
class FxOnnxInterpreter:
    ...
    def run(self, fx_graph_module: torch.fx.GraphModule, onnxfunction_dispatcher: onnxfunction_dispatcher.OnnxFunctionDispatcher, parent_onnxscript_graph: onnxscript_graph_building.TorchScriptGraph | None = ...) -> onnxscript_graph_building.TorchScriptGraph:
    ...
    def placeholder(self, node: torch.fx.Node, onnxscript_graph: onnxscript_graph_building.TorchScriptGraph, fx_name_to_onnxscript_value: dict[str, onnxscript_graph_building.TorchScriptTensor | tuple[onnxscript_graph_building.TorchScriptTensor, ...],]): # -> None:
        ...
    ...
    def output(self, node: torch.fx.Node, onnxscript_graph: onnxscript_graph_building.TorchScriptGraph, fx_name_to_onnxscript_value: dict[str, onnxscript_graph_building.TorchScriptTensor | tuple[onnxscript_graph_building.TorchScriptTensor, ...],]): # -> None:
        ...
    ...
    def get_attr(self, node: torch.fx.Node, onnxscript_graph: onnxscript_graph_building.TorchScriptGraph, fx_name_to_onnxscript_value: dict[str, onnxscript_graph_building.TorchScriptTensor | tuple[onnxscript_graph_building.TorchScriptTensor, ...],], fx_graph_module: torch.fx.GraphModule): # -> None:
        ...
