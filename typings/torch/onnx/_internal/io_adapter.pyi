...
class InputAdaptStep(Protocol):
    ...
    """
    def apply(self, model_args: Sequence[Any], model_kwargs: Mapping[str, Any], model: torch.nn.Module | Callable | torch_export.ExportedProgram | None = ...) -> tuple[Sequence[Any], Mapping[str, Any]]:
        ...
...
class InputAdapter:
    ...
    def apply(self, *model_args, model: torch.nn.Module | Callable | torch_export.ExportedProgram | None = ..., **model_kwargs) -> Sequence[int | float | bool | str | torch.Tensor | torch.dtype | None]:
...
class OutputAdaptStep(Protocol):
    ...
    """
    def apply(self, model_outputs: Any, model: torch.nn.Module | Callable | torch_export.ExportedProgram | None = ...) -> Any:
        ...
...
class OutputAdapter:
    ...
    def apply(self, model_outputs: Any, model: torch.nn.Module | Callable | torch_export.ExportedProgram | None = ...) -> Sequence[torch.Tensor | int | float | bool | str]:
...
class BindInputStep(InputAdaptStep):
    ...
    def __init__(self, model_signature: inspect.Signature) -> None:
        ...
