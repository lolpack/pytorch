...
def verify_onnx_program(onnx_program: _onnx_program.ONNXProgram, args: tuple[Any, ...] | None = ..., kwargs: dict[str, Any] | None = ..., compare_intermediates: bool = ...) -> list[VerificationInfo]:
...
class _VerificationInterpreter(torch.fx.Interpreter):
    ...
    def run(self, *args: Any, initial_env: dict[torch.fx.Node, Any] | None = ..., enable_io_processing: bool = ...) -> Any:
