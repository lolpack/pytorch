...
if TYPE_CHECKING:
    ...
def from_dynamic_axes_to_dynamic_shapes(model, args: tuple[Any, ...], kwargs: dict[str, Any] | None, *, dynamic_axes=..., output_names: set[str], input_names: Sequence[str] | None = ...) -> tuple[dict[str, Any | None] | None, tuple[Any, ...], dict[str, Any] | None]:
    """
