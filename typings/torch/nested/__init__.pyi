...
def as_nested_tensor(ts: Union[Tensor, list[Tensor], tuple[Tensor, ...]], dtype: Optional[DType] = ..., device: Optional[Device] = ..., layout=...) -> Tensor:
    r"""
...
def narrow(tensor: Tensor, dim: int, start: Union[int, Tensor], length: Union[int, Tensor], layout=...) -> Tensor:
    r"""
...
def nested_tensor_from_jagged(values: Tensor, offsets: Optional[Tensor] = ..., lengths: Optional[Tensor] = ..., jagged_dim: Optional[int] = ..., min_seqlen: Optional[int] = ..., max_seqlen: Optional[int] = ...) -> Tensor:
    r"""
