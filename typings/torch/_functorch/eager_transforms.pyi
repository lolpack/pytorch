...
def vjp(func: Callable, *primals, has_aux: bool = ...): # -> tuple[PyTree, Callable[..., PyTree], PyTree | Any] | tuple[PyTree, Callable[..., PyTree]]:
    """
...
@exposed_in("torch.func")
def jacrev(func: Callable, argnums: Union[int, tuple[int]] = ..., *, has_aux=..., chunk_size: Optional[int] = ..., _preallocate_and_copy=...): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], tuple[PyTree, PyTree | Any] | PyTree]:
    """
...
@exposed_in("torch.func")
def jvp(func: Callable, primals: Any, tangents: Any, *, strict: bool = ..., has_aux: bool = ...): # -> tuple[PyTree, PyTree, PyTree | Any] | tuple[PyTree, PyTree]:
    """
...
@exposed_in("torch.func")
def jacfwd(func: Callable, argnums: argnums_t = ..., has_aux: bool = ..., *, randomness: str = ...): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], tuple[PyTree, PyTree | Any] | PyTree]:
    """
    Computes the Jacobian of ``func`` with respect to the arg(s) at index
...
@exposed_in("torch.func")
def hessian(func, argnums=...): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], tuple[PyTree, PyTree | Any] | PyTree]:
    """
