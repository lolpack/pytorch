...
def vmap(func: Callable, in_dims: in_dims_t = ..., out_dims: out_dims_t = ..., randomness: str = ..., *, chunk_size=...) -> Callable:
    """
...
def chunk_vmap(func: Callable, in_dims: in_dims_t = ..., out_dims: out_dims_t = ..., randomness: str = ..., chunks=...) -> Callable:
    """
