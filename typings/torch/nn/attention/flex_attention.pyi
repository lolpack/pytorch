...
class BlockMask:
    ...
    **Details**
    ...
    def __init__(self, seq_lengths: tuple[int, int], kv_num_blocks: Tensor, kv_indices: Tensor, full_kv_num_blocks: Optional[Tensor], full_kv_indices: Optional[Tensor], q_num_blocks: Optional[Tensor], q_indices: Optional[Tensor], full_q_num_blocks: Optional[Tensor], full_q_indices: Optional[Tensor], BLOCK_SIZE: tuple[int, int], mask_mod: _mask_mod_signature) -> None:
        ...
    
    @classmethod
    def from_kv_blocks(cls, kv_num_blocks: Tensor, kv_indices: Tensor, full_kv_num_blocks: Optional[Tensor] = ..., full_kv_indices: Optional[Tensor] = ..., BLOCK_SIZE: Union[int, tuple[int, int]] = ..., mask_mod: Optional[_mask_mod_signature] = ..., seq_lengths: Optional[tuple[int, int]] = ...): # -> Self:
        """
...
def create_mask(mod_fn: Union[_score_mod_signature, _mask_mod_signature], B: Optional[int], H: Optional[int], Q_LEN: int, KV_LEN: int, device: DeviceLikeType = ...) -> Tensor:
...
def create_block_mask(mask_mod: _mask_mod_signature, B: Optional[int], H: Optional[int], Q_LEN: int, KV_LEN: int, device: DeviceLikeType = ..., BLOCK_SIZE: Union[int, tuple[int, int]] = ..., _compile=...) -> BlockMask:
...
def create_nested_block_mask(mask_mod: _mask_mod_signature, B: Optional[int], H: Optional[int], q_nt: torch.Tensor, kv_nt: Optional[torch.Tensor] = ..., BLOCK_SIZE: Union[int, tuple[int, int]] = ..., _compile=...) -> BlockMask:
...
def flex_attention(query: Tensor, key: Tensor, value: Tensor, score_mod: Optional[_score_mod_signature] = ..., block_mask: Optional[BlockMask] = ..., scale: Optional[float] = ..., enable_gqa: bool = ..., return_lse: bool = ..., kernel_options: Optional[dict[str, Any]] = ...) -> Union[Tensor, tuple[Tensor, Tensor]]:
