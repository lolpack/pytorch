...
class ParametrizationList(ModuleList):
    ...
    original: Tensor
    unsafe: bool
    def __init__(self, modules: Sequence[Module], original: Union[Tensor, Parameter], unsafe: bool = ...) -> None:
        ...
...
def is_parametrized(module: Module, tensor_name: Optional[str] = ...) -> bool:
...
def transfer_parametrizations_and_params(from_module: Module, to_module: Module, tensor_name: Optional[str] = ...) -> Module:
