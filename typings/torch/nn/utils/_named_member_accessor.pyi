...
def swap_tensor(module: torch.nn.Module, name: str, tensor: torch.Tensor, allow_missing: bool = ...) -> torch.Tensor:
    ...
...
class NamedMemberAccessor:
    ...
    def swap_tensor(self, name: str, value: torch.Tensor, allow_missing: bool = ...) -> torch.Tensor:
        """
    ...
    def swap_tensors(self, names: Iterable[str], values: Iterable[torch.Tensor], allow_missing: bool = ...) -> list[torch.Tensor]:
        """
    ...
    def swap_tensors_dict(self, named_tensors: dict[str, torch.Tensor], allow_missing: bool = ...) -> tuple[dict[str, torch.Tensor], list[str]]:
        """
        Swap the attributes specified by the given paths to values.
    ...
    def named_parameters(self, remove_duplicate: bool = ...) -> Iterable[tuple[str, torch.Tensor]]:
        """Iterate over all the parameters in the module."""
        ...
    
    def named_buffers(self, remove_duplicate: bool = ...) -> Iterable[tuple[str, torch.Tensor]]:
        """Iterate over all the buffers in the module."""
        ...
    
    def named_tensors(self, remove_duplicate: bool = ...) -> Iterable[tuple[str, torch.Tensor]]:
        """Iterate over all the tensors in the module."""
        ...
    
    def named_modules(self, remove_duplicate: bool = ...) -> Iterable[tuple[str, torch.nn.Module]]:
