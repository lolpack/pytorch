...
def convert_conv2d_weight_memory_format(module: _M, memory_format: torch.memory_format) -> _M:
...
def convert_conv3d_weight_memory_format(module: _M, memory_format: torch.memory_format) -> _M:
