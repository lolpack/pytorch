...
def fuse_conv_bn_eval(conv: ConvT, bn: torch.nn.modules.batchnorm._BatchNorm, transpose: bool = ...) -> ConvT:
...
def fuse_conv_bn_weights(conv_w: torch.Tensor, conv_b: torch.Tensor | None, bn_rm: torch.Tensor, bn_rv: torch.Tensor, bn_eps: float, bn_w: torch.Tensor | None, bn_b: torch.Tensor | None, transpose: bool = ...) -> tuple[torch.nn.Parameter, torch.nn.Parameter]:
