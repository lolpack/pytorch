...
def functional_call(module: torch.nn.Module, parameters_and_buffers: dict[str, Tensor], args: Optional[Union[Any, tuple]] = ..., kwargs: Optional[dict[str, Any]] = ..., *, tie_weights: bool = ..., strict: bool = ...): # -> Any:
