...
class PackedSequence(PackedSequence_):
    ...
    """
    def __new__(cls, data: Tensor, batch_sizes: Optional[Tensor] = ..., sorted_indices: Optional[Tensor] = ..., unsorted_indices: Optional[Tensor] = ...) -> Self:
        ...
    ...
    @overload
    def to(self, device: Optional[Union[str, torch.device, int]] = ..., dtype: Optional[torch.dtype] = ..., non_blocking: bool = ..., copy: bool = ...) -> Self:
        ...
...
def pack_padded_sequence(input: Tensor, lengths: Union[Tensor, list[int]], batch_first: bool = ..., enforce_sorted: bool = ...) -> PackedSequence:
...
def pad_sequence(sequences: Union[Tensor, list[Tensor]], batch_first: bool = ..., padding_value: float = ..., padding_side: str = ...) -> Tensor:
