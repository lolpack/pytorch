...
"""Gradient interface."""
def conv1d_input(input_size, weight, grad_output, stride=..., padding=..., dilation=..., groups=...): # -> Any:
...
def conv1d_weight(input, weight_size, grad_output, stride=..., padding=..., dilation=..., groups=...): # -> Any:
...
def conv2d_input(input_size, weight, grad_output, stride=..., padding=..., dilation=..., groups=...): # -> Any:
...
def conv2d_weight(input, weight_size, grad_output, stride=..., padding=..., dilation=..., groups=...): # -> Any:
...
def conv3d_input(input_size, weight, grad_output, stride=..., padding=..., dilation=..., groups=...): # -> Any:
...
def conv3d_weight(input, weight_size, grad_output, stride=..., padding=..., dilation=..., groups=...): # -> Any:
