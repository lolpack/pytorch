...
from torch._jit_internal import BroadcastingList1, BroadcastingList2, BroadcastingList3, _overload
...
def lp_pool3d(input: Tensor, norm_type: Union[int, float], kernel_size: BroadcastingList3[int], stride: Optional[BroadcastingList3[int]] = ..., ceil_mode: bool = ...) -> Tensor:
    r"""
...
def lp_pool2d(input: Tensor, norm_type: Union[int, float], kernel_size: BroadcastingList2[int], stride: Optional[BroadcastingList2[int]] = ..., ceil_mode: bool = ...) -> Tensor:
    r"""
...
def lp_pool1d(input: Tensor, norm_type: Union[int, float], kernel_size: int, stride: Optional[BroadcastingList1[int]] = ..., ceil_mode: bool = ...) -> Tensor:
...
adaptive_max_pool1d = ...
def adaptive_max_pool2d_with_indices(input: Tensor, output_size: BroadcastingList2[int], return_indices: bool = ...) -> tuple[Tensor, Tensor]:
...
adaptive_max_pool2d = ...
def adaptive_max_pool3d_with_indices(input: Tensor, output_size: BroadcastingList3[int], return_indices: bool = ...) -> tuple[Tensor, Tensor]:
    r"""
...
softplus = ...
def softmin(input: Tensor, dim: Optional[int] = ..., _stacklevel: int = ..., dtype: Optional[DType] = ...) -> Tensor:
...
def softmax(input: Tensor, dim: Optional[int] = ..., _stacklevel: int = ..., dtype: Optional[DType] = ...) -> Tensor:
...
def log_softmax(input: Tensor, dim: Optional[int] = ..., _stacklevel: int = ..., dtype: Optional[DType] = ...) -> Tensor:
...
def embedding_bag(input: Tensor, weight: Tensor, offsets: Optional[Tensor] = ..., max_norm: Optional[float] = ..., norm_type: float = ..., scale_grad_by_freq: bool = ..., mode: str = ..., sparse: bool = ..., per_sample_weights: Optional[Tensor] = ..., include_last_offset: bool = ..., padding_idx: Optional[int] = ...) -> Tensor:
...
def rms_norm(input: Tensor, normalized_shape: list[int], weight: Optional[Tensor] = ..., eps: Optional[float] = ...) -> Tensor:
...
def gaussian_nll_loss(input: Tensor, target: Tensor, var: Union[Tensor, float], full: bool = ..., eps: float = ..., reduction: str = ...) -> Tensor:
...
def cross_entropy(input: Tensor, target: Tensor, weight: Optional[Tensor] = ..., size_average: Optional[bool] = ..., ignore_index: int = ..., reduce: Optional[bool] = ..., reduction: str = ..., label_smoothing: float = ...) -> Tensor:
...
def smooth_l1_loss(input: Tensor, target: Tensor, size_average: Optional[bool] = ..., reduce: Optional[bool] = ..., reduction: str = ..., beta: float = ...) -> Tensor:
...
def huber_loss(input: Tensor, target: Tensor, reduction: str = ..., delta: float = ..., weight: Optional[Tensor] = ...) -> Tensor:
...
def l1_loss(input: Tensor, target: Tensor, size_average: Optional[bool] = ..., reduce: Optional[bool] = ..., reduction: str = ..., weight: Optional[Tensor] = ...) -> Tensor:
...
def mse_loss(input: Tensor, target: Tensor, size_average: Optional[bool] = ..., reduce: Optional[bool] = ..., reduction: str = ..., weight: Optional[Tensor] = ...) -> Tensor:
...
@_overload
def upsample(input: Tensor, size: Optional[int] = ..., scale_factor: Optional[float] = ..., mode: str = ..., align_corners: Optional[bool] = ...) -> Tensor:
    ...

@_overload
def upsample(input: Tensor, size: Optional[list[int]] = ..., scale_factor: Optional[float] = ..., mode: str = ..., align_corners: Optional[bool] = ...) -> Tensor:
    ...
...
if upsample.__doc__:
    ...
@_overload
def interpolate(input: Tensor, size: Optional[int] = ..., scale_factor: Optional[list[float]] = ..., mode: str = ..., align_corners: Optional[bool] = ..., recompute_scale_factor: Optional[bool] = ..., antialias: bool = ...) -> Tensor:
    ...

@_overload
def interpolate(input: Tensor, size: Optional[list[int]] = ..., scale_factor: Optional[list[float]] = ..., mode: str = ..., align_corners: Optional[bool] = ..., recompute_scale_factor: Optional[bool] = ..., antialias: bool = ...) -> Tensor:
    ...

@_overload
def interpolate(input: Tensor, size: Optional[int] = ..., scale_factor: Optional[float] = ..., mode: str = ..., align_corners: Optional[bool] = ..., recompute_scale_factor: Optional[bool] = ..., antialias: bool = ...) -> Tensor:
    ...

@_overload
def interpolate(input: Tensor, size: Optional[list[int]] = ..., scale_factor: Optional[float] = ..., mode: str = ..., align_corners: Optional[bool] = ..., recompute_scale_factor: Optional[bool] = ..., antialias: bool = ...) -> Tensor:
    ...
...
if interpolate.__doc__:
    ...
@_overload
def upsample_nearest(input: Tensor, size: Optional[int] = ..., scale_factor: Optional[float] = ...) -> Tensor:
    ...

@_overload
def upsample_nearest(input: Tensor, size: Optional[list[int]] = ..., scale_factor: Optional[float] = ...) -> Tensor:
    ...
...
if upsample_nearest.__doc__:
    ...
@_overload
def upsample_bilinear(input: Tensor, size: Optional[int] = ..., scale_factor: Optional[float] = ...) -> Tensor:
    ...

@_overload
def upsample_bilinear(input: Tensor, size: Optional[list[int]] = ..., scale_factor: Optional[float] = ...) -> Tensor:
    ...

@_overload
def upsample_bilinear(input: Tensor, size: Optional[int] = ..., scale_factor: Optional[list[float]] = ...) -> Tensor:
    ...

@_overload
def upsample_bilinear(input: Tensor, size: Optional[list[int]] = ..., scale_factor: Optional[list[float]] = ...) -> Tensor:
    ...
...
def grid_sample(input: Tensor, grid: Tensor, mode: str = ..., padding_mode: str = ..., align_corners: Optional[bool] = ...) -> Tensor:
...
def affine_grid(theta: Tensor, size: list[int], align_corners: Optional[bool] = ...) -> Tensor:
...
def pad(input: Tensor, pad: list[int], mode: str = ..., value: Optional[float] = ...) -> Tensor:
    r"""
...
def triplet_margin_with_distance_loss(anchor: Tensor, positive: Tensor, negative: Tensor, *, distance_function: Optional[Callable[[Tensor, Tensor], Tensor]] = ..., margin: float = ..., swap: bool = ..., reduction: str = ...) -> Tensor:
...
def multi_head_attention_forward(query: Tensor, key: Tensor, value: Tensor, embed_dim_to_check: int, num_heads: int, in_proj_weight: Optional[Tensor], in_proj_bias: Optional[Tensor], bias_k: Optional[Tensor], bias_v: Optional[Tensor], add_zero_attn: bool, dropout_p: float, out_proj_weight: Tensor, out_proj_bias: Optional[Tensor], training: bool = ..., key_padding_mask: Optional[Tensor] = ..., need_weights: bool = ..., attn_mask: Optional[Tensor] = ..., use_separate_proj_weight: bool = ..., q_proj_weight: Optional[Tensor] = ..., k_proj_weight: Optional[Tensor] = ..., v_proj_weight: Optional[Tensor] = ..., static_k: Optional[Tensor] = ..., static_v: Optional[Tensor] = ..., average_attn_weights: bool = ..., is_causal: bool = ...) -> tuple[Tensor, Optional[Tensor]]:
