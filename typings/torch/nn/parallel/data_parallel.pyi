...
class DataParallel(Module, Generic[T]):
    ...
    **scattered** on dim specified (default 0). tuple, list and dict types will
    ...
    """
    def __init__(self, module: T, device_ids: Optional[Sequence[Union[int, torch.device]]] = ..., output_device: Optional[Union[int, torch.device]] = ..., dim: int = ...) -> None:
        ...
    ...
    def scatter(self, inputs: tuple[Any, ...], kwargs: Optional[dict[str, Any]], device_ids: Sequence[Union[int, torch.device]]) -> Any:
        ...
...
def data_parallel(module: Module, inputs: Any, device_ids: Optional[Sequence[Union[int, torch.device]]] = ..., output_device: Optional[Union[int, torch.device]] = ..., dim: int = ..., module_kwargs: Optional[Any] = ...) -> torch.Tensor:
