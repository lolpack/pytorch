...
_global_is_full_backward_hook: Optional[bool] = ...
...
class Module:
    ...
    def cuda(self, device: Optional[Union[int, device]] = ...) -> Self:
    ...
    def ipu(self, device: Optional[Union[int, device]] = ...) -> Self:
    ...
    def xpu(self, device: Optional[Union[int, device]] = ...) -> Self:
    ...
    def mtia(self, device: Optional[Union[int, device]] = ...) -> Self:
    ...
    def to_empty(self, *, device: Optional[DeviceLikeType], recurse: bool = ...) -> Self:
    ...
    def named_modules(self, memo: Optional[set[Module]] = ..., prefix: str = ..., remove_duplicate: bool = ...): # -> Generator[tuple[str, Self] | Any, Any, None]:
