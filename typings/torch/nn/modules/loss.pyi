...
class CrossEntropyLoss(_WeightedLoss):
    ...
    def __init__(self, weight: Optional[Tensor] = ..., size_average=..., ignore_index: int = ..., reduce=..., reduction: str = ..., label_smoothing: float = ...) -> None:
        ...
...
class TripletMarginWithDistanceLoss(_Loss):
    ...
    margin: float
    swap: bool
    def __init__(self, *, distance_function: Optional[Callable[[Tensor, Tensor], Tensor]] = ..., margin: float = ..., swap: bool = ..., reduction: str = ...) -> None:
        ...
