...
def calculate_gain(nonlinearity: _NonlinearityType, param: _Optional[Union[int, float]] = ...) -> float:
...
def uniform_(tensor: Tensor, a: float = ..., b: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def normal_(tensor: Tensor, mean: float = ..., std: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def trunc_normal_(tensor: Tensor, mean: float = ..., std: float = ..., a: float = ..., b: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def xavier_uniform_(tensor: Tensor, gain: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def xavier_normal_(tensor: Tensor, gain: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def kaiming_uniform_(tensor: Tensor, a: float = ..., mode: _FanMode = ..., nonlinearity: _NonlinearityType = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def kaiming_normal_(tensor: Tensor, a: float = ..., mode: _FanMode = ..., nonlinearity: _NonlinearityType = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def orthogonal_(tensor: Tensor, gain: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
...
def sparse_(tensor: Tensor, sparsity: float, std: float = ..., generator: _Optional[torch.Generator] = ...) -> Tensor:
