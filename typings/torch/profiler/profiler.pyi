...
class _KinetoProfile:
    ...
    .. note::
        ...
        extra tensor copies.
    """
    def __init__(self, *, activities: Optional[Iterable[ProfilerActivity]] = ..., record_shapes: bool = ..., profile_memory: bool = ..., with_stack: bool = ..., with_flops: bool = ..., with_modules: bool = ..., experimental_config: Optional[_ExperimentalConfig] = ..., execution_trace_observer: Optional[_ITraceObserver] = ..., acc_events: bool = ..., custom_trace_id_callback: Optional[Callable[[], str]] = ...) -> None:
        ...
    ...
    def export_memory_timeline(self, path: str, device: Optional[str] = ...) -> None:
...
def tensorboard_trace_handler(dir_name: str, worker_name: Optional[str] = ..., use_gzip: bool = ...): # -> Callable[..., None]:
    """
...
class profile(_KinetoProfile):
    ...
    """
    def __init__(self, *, activities: Optional[Iterable[ProfilerActivity]] = ..., schedule: Optional[Callable[[int], ProfilerAction]] = ..., on_trace_ready: Optional[Callable[..., Any]] = ..., record_shapes: bool = ..., profile_memory: bool = ..., with_stack: bool = ..., with_flops: bool = ..., with_modules: bool = ..., experimental_config: Optional[_ExperimentalConfig] = ..., execution_trace_observer: Optional[_ITraceObserver] = ..., acc_events: bool = ..., use_cuda: Optional[bool] = ..., custom_trace_id_callback: Optional[Callable[[], str]] = ...) -> None:
        ...
...
class ExecutionTraceObserver(_ITraceObserver):
    ...
    def get_resources_dir(self, can_create=...) -> Optional[str]:
        """
    ...
    @staticmethod
    def get_resources_dir_for_et_path(trace_path, create_dir: bool = ...) -> Optional[str]:
        ...
