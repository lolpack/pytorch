...
class TritonBundler:
    ...
    """
    _entries: Optional[list[TritonBundleEntry]] = ...
    _static_autotuners: Optional[list[StaticallyLaunchedAutotuner]] = ...
    ...
    @classmethod
    def load_autotuners(cls, static_autotuners: Optional[list[StaticallyLaunchedAutotuner]]) -> list[str]:
        """
    ...
    @classmethod
    def collect(cls) -> tuple[TritonBundle, Optional[TritonBundlerMetadata]]:
        """
