...
class InductorBenchmarker(TritonBenchmarker):
    ...
    @time_and_count
    def benchmark_gpu(self: Self, _callable: Callable[[], Any], estimation_iters: int = ..., memory_warmup_iters: int = ..., benchmark_iters: int = ..., max_benchmark_duration: int = ..., **kwargs: Any) -> float:
