...
from torch.utils._pytree import FlattenFunc, FromDumpableContextFn, ToDumpableContextFn, UnflattenFunc
...
def export_for_training(mod: torch.nn.Module, args: tuple[Any, ...], kwargs: Optional[dict[str, Any]] = ..., *, dynamic_shapes: Optional[Union[dict[str, Any], tuple[Any], list[Any]]] = ..., strict: bool = ..., preserve_module_call_signature: tuple[str, ...] = ...) -> ExportedProgram:
    """
...
def export(mod: torch.nn.Module, args: tuple[Any, ...], kwargs: Optional[dict[str, Any]] = ..., *, dynamic_shapes: Optional[Union[dict[str, Any], tuple[Any], list[Any]]] = ..., strict: bool = ..., preserve_module_call_signature: tuple[str, ...] = ...) -> ExportedProgram:
    """
...
def save(ep: ExportedProgram, f: FileLike, *, extra_files: Optional[dict[str, Any]] = ..., opset_version: Optional[dict[str, int]] = ..., pickle_protocol: int = ...) -> None:
    """
...
def load(f: FileLike, *, extra_files: Optional[dict[str, Any]] = ..., expected_opset_version: Optional[dict[str, int]] = ...) -> ExportedProgram:
    """
...
def draft_export(mod: torch.nn.Module, args: tuple[Any, ...], kwargs: Optional[dict[str, Any]] = ..., *, dynamic_shapes: Optional[Union[dict[str, Any], tuple[Any], list[Any]]] = ..., preserve_module_call_signature: tuple[str, ...] = ..., strict: bool = ...) -> ExportedProgram:
    """
...
def register_dataclass(cls: type[Any], *, serialized_type_name: Optional[str] = ...) -> None:
    """
