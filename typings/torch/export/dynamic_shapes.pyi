...
class Dim:
    ...
    DYNAMIC = ...
    STATIC = ...
    def __init__(self, name: str, *, min: Optional[int] = ..., max: Optional[int] = ...) -> None:
        ...
...
def dims(*names: str, min: Optional[int] = ..., max: Optional[int] = ...) -> tuple[Dim, ...]:
    """
...
class _IntWrapper:
    ...
    """
    val: int
    dynamism: Optional[Union[_DimHint, int]] = ...
...
def refine_dynamic_shapes_from_suggested_fixes(msg: str, dynamic_shapes: Union[dict[str, Any], tuple[Any], list[Any]]) -> Union[dict[str, Any], tuple[Any], list[Any]]:
    """
