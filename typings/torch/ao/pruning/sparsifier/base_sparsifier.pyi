...
class BaseSparsifier(abc.ABC):
    ...
    def squash_mask(self, params_to_keep: Optional[tuple[str, ...]] = ..., params_to_keep_per_layer: Optional[dict[str, tuple[str, ...]]] = ..., *args, **kwargs): # -> None:
    ...
    def convert(self, module: nn.Module, mapping: Optional[dict[type[nn.Module], type[nn.Module]]] = ..., inplace: bool = ..., parameterization: type[nn.Module] = ...): # -> Module:
