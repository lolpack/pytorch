...
class DTypeWithConstraints:
    ...
    * `scale_exact_match` and `zero_point_exact_match`: Exact match requirements
    ...
    quant_min_lower_bound: Union[int, float, None] = ...
    quant_max_upper_bound: Union[int, float, None] = ...
    scale_min_lower_bound: Union[int, float, None] = ...
    scale_max_upper_bound: Union[int, float, None] = ...
...
scale_min_lower_bound=None, scale_max_upper_bound=None)
    ...
    def __init__(self, input_dtype: Union[torch.dtype, DTypeWithConstraints, None] = ..., output_dtype: Union[torch.dtype, DTypeWithConstraints, None] = ..., weight_dtype: Union[torch.dtype, DTypeWithConstraints, None] = ..., bias_dtype: Optional[torch.dtype] = ..., is_dynamic: Optional[bool] = ...) -> None:
        ...
