...
def find_sequential_partitions(gm: torch.fx.GraphModule, partition_types: list[Any], include_functional_equivalent=..., filter_fn: Optional[Callable[[Node], bool]] = ...): # -> list[tuple[SourcePartition, ...]]:
    ...

def bfs_trace_with_node_process(model: Union[ExportedProgram, torch.fx.GraphModule], node_op: Callable) -> None:
