...
class AffineQuantizedObserverBase(ABC, torch.nn.Module):
    ...
    """
    with_args = ...
    def __init__(self, mapping_type: MappingType, target_dtype: torch.dtype, granularity: Granularity, quant_min: Optional[int] = ..., quant_max: Optional[int] = ..., eps: Optional[float] = ..., scale_dtype: Optional[torch.dtype] = ..., zero_point_dtype: Optional[torch.dtype] = ..., preserve_zero: bool = ..., zero_point_domain: Optional[ZeroPointDomain] = ..., **kwargs) -> None:
        ...
