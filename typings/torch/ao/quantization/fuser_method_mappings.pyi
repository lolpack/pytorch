...
def get_fuser_method(op_list, additional_fuser_method_mapping=...): # -> Sequential | Callable[..., Any]:
...
def get_fuser_method_new(op_pattern: Pattern, fuser_method_mapping: dict[Pattern, Union[nn.Sequential, Callable]]): # -> Sequential | Callable[..., Any]:
    """Get fuser method.
