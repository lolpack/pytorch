...
def get_linear_prepack_op_for_dtype(dtype): # -> OpOverloadPacket[Callable[..., Any], Any]:
    ...
...
def maybe_get_next_module(node: Node, modules: dict[str, nn.Module], target_module_type: Optional[type[nn.Module]] = ..., target_functional_type: Any = ...) -> Optional[Node]:
