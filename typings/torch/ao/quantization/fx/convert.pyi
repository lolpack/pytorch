...
def convert_weighted_module(node: Node, modules: dict[str, torch.nn.Module], observed_node_names: set[str], node_name_to_qconfig: dict[str, QConfigAny], backend_config: BackendConfig, is_decomposed: bool = ..., is_reference: bool = ...) -> None:
...
def convert(model: GraphModule, is_reference: bool = ..., convert_custom_config: Union[ConvertCustomConfig, dict[str, Any], None] = ..., is_standalone_module: bool = ..., _remove_qconfig_flag: bool = ..., qconfig_mapping: Union[QConfigMapping, dict[str, Any], None] = ..., backend_config: Union[BackendConfig, dict[str, Any], None] = ..., is_decomposed: bool = ..., keep_original_weights: bool = ...) -> GraphModule:
    """
