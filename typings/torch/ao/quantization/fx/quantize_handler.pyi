...
class QuantizeHandler(ABC):
    ...
    def __init__(self, node_pattern: NodePattern, modules: dict[str, torch.nn.Module], root_node_getter: Optional[Callable] = ..., is_custom_module=..., is_standalone_module=...) -> None:
