...
from .pt2e._numeric_debugger import CUSTOM_KEY, NUMERIC_DEBUG_HANDLE_KEY, compare_results, extract_results_from_loggers, generate_numeric_debug_handle, prepare_for_propagation_comparison
...
class _DerivedObserverOrFakeQuantize(ObserverBase):
    ...
    """
    def __init__(self, dtype: torch.dtype, obs_or_fqs: list[ObserverOrFakeQuantize], derive_qparams_fn: Callable[[list[ObserverOrFakeQuantize]], tuple[Tensor, Tensor]], quant_min: Optional[int] = ..., quant_max: Optional[int] = ..., qscheme: Optional[torch.qscheme] = ..., ch_axis: Optional[int] = ...) -> None:
        ...
