...
scan_op = ...
def generic_scan(operator, init, xs, dim=..., additional_inputs=...): # -> tuple[Any, list[Any]] | list[Any]:
    ...
...
def scan_op_dense(combine_fn, init, xs, additional_inputs): # -> tuple[Any, list[Any]] | list[Any]:
    ...
...
class ScanAutogradOp(torch.autograd.Function):
    ...
    """
    @staticmethod
    def forward(ctx, combine_fn, num_leaves_init, num_leaves_xs, num_additional_inputs, *operands): # -> tuple[Any, ...]:
        ...
