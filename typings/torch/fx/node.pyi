...
class Node(_NodeBase):
    ...
    @compatibility(is_backward_compatible=True)
    def format_node(self, placeholder_names: Optional[list[str]] = ..., maybe_return_typename: Optional[list[str]] = ...) -> Optional[str]:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def replace_all_uses_with(self, replace_with: Node, delete_user_cb: Callable[[Node], bool] = ..., *, propagate_meta: bool = ...) -> list[Node]:
        """
