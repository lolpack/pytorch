...
class GraphModule(torch.nn.Module):
    ...
    def __reduce_deploy__(self, importer: Importer): # -> tuple[Callable[..., Module], tuple[dict[str, Any], str]]:
        ...
    ...
    @compatibility(is_backward_compatible=False)
    def print_readable(self, print_output=..., include_stride=..., include_device=..., colored=..., *, fast_sympy_print: bool = ...): # -> str:
        """
