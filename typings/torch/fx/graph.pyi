...
class _PyTreeCodeGen(CodeGen):
    ...
    def gen_fn_def(self, free_vars, maybe_return_annotation): # -> str:
        ...
...
class Graph:
    ...
    @compatibility(is_backward_compatible=True)
    def python_code(self, root_module: str, *, verbose: bool = ..., include_stride: bool = ..., include_device: bool = ..., colored: bool = ...) -> PythonCode:
        """
