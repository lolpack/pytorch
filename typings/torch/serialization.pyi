...
from typing import Any, Callable, Generic, IO, Optional, TypeVar, Union
...
def register_package(priority: int, tagger: Callable[[STORAGE], Optional[str]], deserializer: Callable[[STORAGE, str], Optional[STORAGE]]): # -> None:
    """
...
def location_tag(storage: Union[Storage, torch.storage.TypedStorage, torch.UntypedStorage]): # -> str:
    ...
...
def load(f: FileLike, map_location: MAP_LOCATION = ..., pickle_module: Any = ..., *, weights_only: Optional[bool] = ..., mmap: Optional[bool] = ..., **pickle_load_args: Any) -> Any:
