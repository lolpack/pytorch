...
class AveragedModel(Module):
    ...
    """
    n_averaged: Tensor
    def __init__(self, model: Module, device: Optional[Union[int, torch.device]] = ..., avg_fn: Optional[Callable[[Tensor, Tensor, Union[Tensor, int]], Tensor]] = ..., multi_avg_fn: Optional[Callable[[PARAM_LIST, PARAM_LIST, Union[Tensor, int]], None]] = ..., use_buffers=...) -> None:
        ...
