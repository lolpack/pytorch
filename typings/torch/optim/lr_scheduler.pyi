...
from typing import Any, Callable, Literal, Optional, SupportsFloat, TYPE_CHECKING, TypedDict, Union
...
class ReduceLROnPlateau(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, mode: Literal["min", "max"] = ..., factor: float = ..., patience: int = ..., threshold: float = ..., threshold_mode: Literal["rel", "abs"] = ..., cooldown: int = ..., min_lr: Union[list[float], float] = ..., eps: float = ...) -> None:
        ...
...
class CyclicLR(LRScheduler):
    ...
    * "exp_range": A cycle that scales initial amplitude by :math:`\text{gamma}^{\text{cycle iterations}}`
    ...
    """
    def __init__(self, optimizer: Optimizer, base_lr: Union[float, list[float]], max_lr: Union[float, list[float]], step_size_up: int = ..., step_size_down: Optional[int] = ..., mode: Literal["triangular", "triangular2", "exp_range"] = ..., gamma: float = ..., scale_fn: Optional[Callable[[float], float]] = ..., scale_mode: Literal["cycle", "iterations"] = ..., cycle_momentum: bool = ..., base_momentum: float = ..., max_momentum: float = ..., last_epoch: int = ...) -> None:
        ...
...
class OneCycleLR(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, max_lr: Union[float, list[float]], total_steps: Optional[int] = ..., epochs: Optional[int] = ..., steps_per_epoch: Optional[int] = ..., pct_start: float = ..., anneal_strategy: Literal["cos", "linear"] = ..., cycle_momentum: bool = ..., base_momentum: Union[float, list[float]] = ..., max_momentum: Union[float, list[float]] = ..., div_factor: float = ..., final_div_factor: float = ..., three_phase: bool = ..., last_epoch: int = ...) -> None:
        ...
