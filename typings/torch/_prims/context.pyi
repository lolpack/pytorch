...
class TorchRefsMode(torch.overrides.TorchFunctionMode):
    ...
    """
    def __init__(self, strict: bool = ..., should_fallback_fn: Callable[..., bool] = ..., prims_mode_cls: type = ...) -> None:
        ...
    
    def __torch_function__(self, orig_func: Callable[_P, _R], types: Sequence[type], args: Sequence[Any] = ..., kwargs: dict[str, Any] | None = ...) -> Any:
        ...
