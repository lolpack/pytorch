...
class SobolEngine:
    ...
    def draw(self, n: int = ..., out: Optional[torch.Tensor] = ..., dtype: Optional[torch.dtype] = ...) -> torch.Tensor:
        r"""
    ...
    def draw_base2(self, m: int, out: Optional[torch.Tensor] = ..., dtype: Optional[torch.dtype] = ...) -> torch.Tensor:
        r"""
