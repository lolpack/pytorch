...
from typing import Any, Callable, Final, Generic, TypeVar, Union, overload
...
class lazy_property(Generic[T, R]):
    ...
    def __get__(self, instance: Union[T, None], obj_type: Any = ...) -> R | _lazy_property_and_property[T, R]:
        ...
