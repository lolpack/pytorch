...
class Wishart(ExponentialFamily):
    ...
    **References**
    ...
    def __init__(self, df: Union[Tensor, Number], covariance_matrix: Optional[Tensor] = ..., precision_matrix: Optional[Tensor] = ..., scale_tril: Optional[Tensor] = ..., validate_args: Optional[bool] = ...) -> None:
        ...
