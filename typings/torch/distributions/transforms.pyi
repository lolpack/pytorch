...
class AffineTransform(Transform):
    ...
    """
    bijective = ...
    def __init__(self, loc: Union[Tensor, float], scale: Union[Tensor, float], event_dim: int = ..., cache_size: int = ...) -> None:
        ...
    ...
    @property
    def sign(self) -> Union[Tensor, int]:
        ...
...
class CatTransform(Transform):
    ...
    def __init__(self, tseq: Sequence[Transform], dim: int = ..., lengths: Optional[Sequence[int]] = ..., cache_size: int = ...) -> None:
        ...
