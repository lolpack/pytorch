...
if not is_available():
    ...
    class _MeshEnv(threading.local):
        ...
        def create_flatten_mesh(self, device_mesh: DeviceMesh, mesh_dim_name: Optional[str] = ...) -> DeviceMesh:
            ...
    ...
    class DeviceMesh:
        ...
        def __init__(self, device_type: str, mesh: Union[torch.Tensor, ArrayLike], *, mesh_dim_names: Optional[tuple[str, ...]] = ..., _init_backend: bool = ...) -> None:
            ...
        ...
        @staticmethod
        def from_group(group: Union[ProcessGroup, list[ProcessGroup]], device_type: str, mesh: Optional[Union[torch.Tensor, ArrayLike]] = ..., *, mesh_dim_names: Optional[tuple[str, ...]] = ...) -> DeviceMesh:
            """
    ...
    def init_device_mesh(device_type: str, mesh_shape: tuple[int, ...], *, mesh_dim_names: Optional[tuple[str, ...]] = ...) -> DeviceMesh:
        """
