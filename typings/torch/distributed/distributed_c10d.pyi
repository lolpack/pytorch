...
class P2POp:
    ...
    """
    def __init__(self, op: Callable, tensor: torch.Tensor, peer: Optional[int] = ..., group: Optional[ProcessGroup] = ..., tag: int = ..., group_peer: Optional[int] = ...) -> None:
        """Init."""
        ...
    
    def __new__(cls, op: Callable, tensor: torch.Tensor, peer: Optional[int] = ..., group: Optional[ProcessGroup] = ..., tag: int = ..., group_peer: Optional[int] = ...): # -> Self:
        """Create and return a new instance of the class."""
        ...
...
class _CollOp:
    ...
    """
    def __init__(self, op: Callable, tensor: torch.Tensor, dst_tensor: Optional[torch.Tensor] = ..., redop: Optional[ReduceOp] = ..., root: Optional[int] = ...) -> None:
        ...
...
@_exception_logger
@_time_logger
def init_process_group(backend: Optional[str] = ..., init_method: Optional[str] = ..., timeout: Optional[timedelta] = ..., world_size: int = ..., rank: int = ..., store: Optional[Store] = ..., group_name: str = ..., pg_options: Optional[Any] = ..., device_id: Optional[Union[torch.device, int]] = ...) -> None:
    """
...
def isend(tensor: torch.Tensor, dst: Optional[int] = ..., group: Optional[ProcessGroup] = ..., tag: int = ..., group_dst: Optional[int] = ...) -> Optional[Work]:
    """
...
def irecv(tensor: torch.Tensor, src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., tag: int = ..., group_src: Optional[int] = ...) -> Optional[Work]:
    """
...
@_exception_logger
def send(tensor: torch.Tensor, dst: Optional[int] = ..., group: Optional[ProcessGroup] = ..., tag: int = ..., group_dst: Optional[int] = ...) -> None:
    """
...
@_exception_logger
def recv(tensor: torch.Tensor, src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., tag: int = ..., group_src: Optional[int] = ...) -> int:
    """
...
@_exception_logger
def broadcast(tensor: torch.Tensor, src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., async_op: bool = ..., group_src: Optional[int] = ...): # -> Work | None:
    """
...
@_exception_logger
def reduce(tensor: torch.Tensor, dst: Optional[int] = ..., op=..., group: Optional[ProcessGroup] = ..., async_op: bool = ..., group_dst: Optional[int] = ...): # -> Work | None:
    """
...
@_exception_logger
def gather_object(obj: Any, object_gather_list: Optional[list[Any]] = ..., dst: Optional[int] = ..., group: Optional[ProcessGroup] = ..., group_dst: Optional[int] = ...): # -> None:
    """
...
@_exception_logger
def send_object_list(object_list: list[Any], dst: Optional[int] = ..., group: Optional[ProcessGroup] = ..., device: Optional[torch.device] = ..., group_dst: Optional[int] = ...): # -> None:
    """
...
@_exception_logger
def recv_object_list(object_list: list[Any], src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., device: Optional[torch.device] = ..., group_src: Optional[int] = ...): # -> int:
    """
...
@_exception_logger
def broadcast_object_list(object_list: list[Any], src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., device: Optional[torch.device] = ..., group_src: Optional[int] = ...): # -> None:
    """
...
@_exception_logger
def scatter_object_list(scatter_object_output_list: list[Any], scatter_object_input_list: Optional[list[Any]] = ..., src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., group_src: Optional[int] = ...): # -> None:
    """
...
@_exception_logger
def gather(tensor: torch.Tensor, gather_list: Optional[list[torch.Tensor]] = ..., dst: Optional[int] = ..., group: Optional[ProcessGroup] = ..., async_op: bool = ..., group_dst: Optional[int] = ...): # -> Work | None:
    """
...
@_exception_logger
def scatter(tensor: torch.Tensor, scatter_list: Optional[list[torch.Tensor]] = ..., src: Optional[int] = ..., group: Optional[ProcessGroup] = ..., async_op: bool = ..., group_src: Optional[int] = ...): # -> Work | None:
    """
...
@_exception_logger
def all_to_all_single(output, input, output_split_sizes=..., input_split_sizes=..., group=..., async_op=...): # -> Any | Work | None:
    """
...
@_time_logger
def split_group(parent_pg: Optional[ProcessGroup] = ..., split_ranks: Optional[list] = ..., timeout: Optional[timedelta] = ..., pg_options: Optional[Any] = ..., group_desc: Optional[str] = ...) -> Optional[ProcessGroup]:
    """
...
@_time_logger
def new_group(ranks=..., timeout=..., backend=..., pg_options=..., use_local_synchronization=..., group_desc=..., device_id: Optional[torch.device] = ...): # -> None:
    """
...
def new_subgroups(group_size=..., group=..., timeout=..., backend=..., pg_options=..., group_desc=...): # -> tuple[Any | None, list[Any]]:
    """
...
def new_subgroups_by_enumeration(ranks_per_subgroup_list, timeout=..., backend=..., pg_options=..., group_desc=...): # -> tuple[Any | None, list[Any]]:
    """
