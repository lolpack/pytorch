...
class WriteItem:
    ...
    index: MetadataIndex
    type: WriteItemType
    bytes_io_data: Optional[BytesIOWriteData] = ...
...
class SavePlanner(abc.ABC):
    ...
    @abc.abstractmethod
    def set_up_planner(self, state_dict: STATE_DICT_TYPE, storage_meta: Optional[StorageMeta] = ..., is_coordinator: bool = ...) -> None:
        """
...
class LoadPlanner:
    ...
    """
    @abc.abstractmethod
    def set_up_planner(self, state_dict: STATE_DICT_TYPE, metadata: Optional[Metadata] = ..., is_coordinator: bool = ...) -> None:
        """
