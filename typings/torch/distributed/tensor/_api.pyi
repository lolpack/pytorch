...
class _ToTorchTensor(torch.autograd.Function):
    @staticmethod
    def forward(ctx, input: DTensor, grad_placements: Optional[Sequence[Placement]]):
        ...
...
class _FromTorchTensor(torch.autograd.Function):
    @staticmethod
    def forward(ctx, input: torch.Tensor, device_mesh: DeviceMesh, placements: tuple[Placement, ...], run_check: bool, shape: Optional[torch.Size] = ..., stride: Optional[tuple[int, ...]] = ...) -> DTensor:
        ...
...
class DTensor(torch.Tensor):
    ...
    * :class:`Partial`: Tensor is pending reduction on the devices of the ``DeviceMesh`` dimension
    ...
    @staticmethod
    def from_local(local_tensor: torch.Tensor, device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ..., *, run_check: bool = ..., shape: Optional[torch.Size] = ..., stride: Optional[tuple[int, ...]] = ...) -> DTensor:
        """
    ...
    def redistribute(self, device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ..., *, async_op: bool = ..., forward_dtype: Optional[torch.dtype] = ..., backward_dtype: Optional[torch.dtype] = ...) -> DTensor:
        """
...
def distribute_tensor(tensor: torch.Tensor, device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ..., *, src_data_rank: Optional[int] = ...) -> DTensor:
    """
...
def distribute_module(module: nn.Module, device_mesh: Optional[DeviceMesh] = ..., partition_fn: Optional[Callable[[str, nn.Module, DeviceMesh], None]] = ..., input_fn: Optional[Callable[[nn.Module, Any, DeviceMesh], None]] = ..., output_fn: Optional[Callable[[nn.Module, Any, DeviceMesh], None]] = ...) -> nn.Module:
    """
...
def ones(*size, dtype: Optional[torch.dtype] = ..., layout: torch.layout = ..., requires_grad: bool = ..., device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ...) -> DTensor:
    """
...
def empty(*size, dtype: Optional[torch.dtype] = ..., layout: torch.layout = ..., requires_grad: bool = ..., device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ...) -> DTensor:
    """
...
def full(size, fill_value, *, dtype: Optional[torch.dtype] = ..., layout: torch.layout = ..., requires_grad: bool = ..., device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ...) -> DTensor:
    """
...
def rand(*size, requires_grad: bool = ..., dtype: Optional[torch.dtype] = ..., layout: torch.layout = ..., device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ...) -> DTensor:
    """
...
def randn(*size, requires_grad: bool = ..., dtype: Optional[torch.dtype] = ..., layout: torch.layout = ..., device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ...) -> DTensor:
    """
...
def zeros(*size, requires_grad: bool = ..., dtype: Optional[torch.dtype] = ..., layout: torch.layout = ..., device_mesh: Optional[DeviceMesh] = ..., placements: Optional[Sequence[Placement]] = ...) -> DTensor:
    """
