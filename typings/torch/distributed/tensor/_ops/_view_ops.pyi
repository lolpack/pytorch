...
def dim_squeeze(shape: Shape, dim: Optional[int] = ...) -> DimMap:
    ...
...
def register_op_strategy_map(aten_op_overload: torch._ops.OpOverload, local_op_name: Callable[..., torch.Tensor], schema_info: Optional[RuntimeSchemaInfo] = ..., strict_view: bool = ...) -> None:
    """
