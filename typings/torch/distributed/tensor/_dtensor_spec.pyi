...
class DTensorSpec:
    ...
    @classmethod
    def from_dim_map(cls, mesh: DeviceMesh, dim_map: list[int], sums: list[int], tensor_meta: Optional[TensorMeta] = ...) -> DTensorSpec:
        """
    ...
    def shallow_copy_with_tensor_meta(self, tensor_meta: Optional[TensorMeta]) -> DTensorSpec:
        """
