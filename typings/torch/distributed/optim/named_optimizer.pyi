...
class _NamedOptimizer(optim.Optimizer):
    ...
    """
    def __init__(self, named_parameters: Mapping[str, Union[torch.Tensor, ShardedTensor]], optimizer_class: optim.Optimizer, param_groups: Optional[Collection[Mapping[str, Any]]] = ..., module: Optional[nn.Module] = ..., *args: tuple[Any, ...], **kwargs: dict[str, Any]) -> None:
        ...
