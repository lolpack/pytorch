...
class FullyShardedDataParallel(nn.Module, _FSDPState):
    ...
    * You should avoid modifying the parameters between forward and
    ...
    """
    def __init__(self, module: nn.Module, process_group: ProcessGroupType = ..., sharding_strategy: Optional[ShardingStrategy] = ..., cpu_offload: Optional[CPUOffload] = ..., auto_wrap_policy: Optional[Union[Callable, ModuleWrapPolicy, CustomPolicy]] = ..., backward_prefetch: Optional[BackwardPrefetch] = ..., mixed_precision: Optional[MixedPrecision] = ..., ignored_modules: Optional[Iterable[torch.nn.Module]] = ..., param_init_fn: Optional[Callable[[nn.Module], None]] = ..., device_id: Optional[Union[int, torch.device]] = ..., sync_module_states: bool = ..., forward_prefetch: bool = ..., limit_all_gathers: bool = ..., use_orig_params: bool = ..., ignored_states: Union[Optional[Iterable[torch.nn.Parameter]], Optional[Iterable[torch.nn.Module]]] = ..., device_mesh: Optional[DeviceMesh] = ...) -> None:
        ...
    ...
    @staticmethod
    def set_state_dict_type(module: nn.Module, state_dict_type: StateDictType, state_dict_config: Optional[StateDictConfig] = ..., optim_state_dict_config: Optional[OptimStateDictConfig] = ...) -> StateDictSettings:
    ...
    def state_dict_type(module: nn.Module, state_dict_type: StateDictType, state_dict_config: Optional[StateDictConfig] = ..., optim_state_dict_config: Optional[OptimStateDictConfig] = ...) -> Generator:
        """Set the ``state_dict_type`` of all the descendant FSDP modules of the target module.
    ...
    @torch.no_grad()
    def clip_grad_norm_(self, max_norm: Union[float, int], norm_type: Union[float, int] = ...) -> torch.Tensor:
    ...
    @staticmethod
    def full_optim_state_dict(model: torch.nn.Module, optim: torch.optim.Optimizer, optim_input: Optional[Union[list[dict[str, Any]], Iterable[torch.nn.Parameter],]] = ..., rank0_only: bool = ..., group: Optional[dist.ProcessGroup] = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def sharded_optim_state_dict(model: torch.nn.Module, optim: torch.optim.Optimizer, group: Optional[dist.ProcessGroup] = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def shard_full_optim_state_dict(full_optim_state_dict: dict[str, Any], model: torch.nn.Module, optim_input: Optional[Union[list[dict[str, Any]], Iterable[torch.nn.Parameter],]] = ..., optim: Optional[torch.optim.Optimizer] = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def scatter_full_optim_state_dict(full_optim_state_dict: Optional[dict[str, Any]], model: torch.nn.Module, optim_input: Optional[Union[list[dict[str, Any]], Iterable[torch.nn.Parameter],]] = ..., optim: Optional[torch.optim.Optimizer] = ..., group: Optional[Any] = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def rekey_optim_state_dict(optim_state_dict: dict[str, Any], optim_state_key_type: OptimStateKeyType, model: torch.nn.Module, optim_input: Optional[Union[list[dict[str, Any]], Iterable[torch.nn.Parameter],]] = ..., optim: Optional[torch.optim.Optimizer] = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def optim_state_dict(model: torch.nn.Module, optim: torch.optim.Optimizer, optim_state_dict: Optional[dict[str, Any]] = ..., group: Optional[dist.ProcessGroup] = ...) -> dict[str, Any]:
        """
    ...
    @staticmethod
    def optim_state_dict_to_load(model: torch.nn.Module, optim: torch.optim.Optimizer, optim_state_dict: dict[str, Any], is_named_optimizer: bool = ..., load_directly: bool = ..., group: Optional[dist.ProcessGroup] = ...) -> dict[str, Any]:
        """
