...
class CustomPolicy(_Policy):
    ...
    """
    def __init__(self, lambda_fn: Callable[[nn.Module], Union[bool, dict[str, Any]]]) -> None:
        ...
...
def size_based_auto_wrap_policy(module: nn.Module, recurse: bool, nonwrapped_numel: int, min_num_params: int = ..., force_leaf_modules: Optional[set[type[nn.Module]]] = ..., exclude_wrap_modules: Optional[set[type[nn.Module]]] = ...) -> bool:
    """
