...
def download_url_to_file(url: str, dst: str, hash_prefix: Optional[str] = ..., progress: bool = ...) -> None:
...
def load_state_dict_from_url(url: str, model_dir: Optional[str] = ..., map_location: MAP_LOCATION = ..., progress: bool = ..., check_hash: bool = ..., file_name: Optional[str] = ..., weights_only: bool = ...) -> dict[str, Any]:
