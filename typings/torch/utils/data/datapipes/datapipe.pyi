...
class IterDataPipe(IterableDataset[_T_co], metaclass=_IterDataPipeMeta):
    ...
    _valid_iterator_id: Optional[int] = ...
    ...
    def __getattr__(self, attribute_name): # -> partial[Any]:
        ...
    ...
    @classmethod
    def register_datapipe_as_function(cls, function_name, cls_to_register, enable_df_api_tracing=...): # -> None:
        ...
    ...
    def __reduce_ex__(self, *args, **kwargs): # -> str | tuple[Any, ...]:
        ...
...
class _DataPipeSerializationWrapper:
    ...
    def __getstate__(self): # -> tuple[bytes | Any, bool]:
        ...
