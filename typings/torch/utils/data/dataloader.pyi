...
class _DatasetKind:
    ...
    Iterable = ...
    @staticmethod
    def create_fetcher(kind, dataset, auto_collation, collate_fn, drop_last): # -> _MapDatasetFetcher | _IterableDatasetFetcher:
        ...
...
class _InfiniteConstantSampler(Sampler):
    ...
    """
    def __iter__(self): # -> Generator[None, Any, NoReturn]:
        ...
...
class DataLoader(Generic[_T_co]):
    ...
    __initialized = ...
    def __init__(self, dataset: Dataset[_T_co], batch_size: Optional[int] = ..., shuffle: Optional[bool] = ..., sampler: Union[Sampler, Iterable, None] = ..., batch_sampler: Union[Sampler[list], Iterable[list], None] = ..., num_workers: int = ..., collate_fn: Optional[_collate_fn_t] = ..., pin_memory: bool = ..., drop_last: bool = ..., timeout: float = ..., worker_init_fn: Optional[_worker_init_fn_t] = ..., multiprocessing_context=..., generator=..., *, prefetch_factor: Optional[int] = ..., persistent_workers: bool = ..., pin_memory_device: str = ..., in_order: bool = ...) -> None:
        ...
