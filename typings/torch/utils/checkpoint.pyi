...
def checkpoint(function, *args, use_reentrant: Optional[bool] = ..., context_fn: Callable[[], Tuple[ContextManager, ContextManager]] = ..., determinism_check: str = ..., debug: bool = ..., **kwargs): # -> Any | None:
...
def checkpoint_sequential(functions, segments, input, use_reentrant=..., **kwargs): # -> Any | None:
