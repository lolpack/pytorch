...
def load(name, sources: Union[str, list[str]], extra_cflags=..., extra_cuda_cflags=..., extra_sycl_cflags=..., extra_ldflags=..., extra_include_paths=..., build_directory=..., verbose=..., with_cuda: Optional[bool] = ..., with_sycl: Optional[bool] = ..., is_python_module=..., is_standalone=..., keep_intermediates=...): # -> None:
    """
...
def load_inline(name, cpp_sources, cuda_sources=..., sycl_sources=..., functions=..., extra_cflags=..., extra_cuda_cflags=..., extra_sycl_cflags=..., extra_ldflags=..., extra_include_paths=..., build_directory=..., verbose=..., with_cuda=..., with_sycl=..., is_python_module=..., with_pytorch_error_handling=..., keep_intermediates=..., use_pch=..., no_implicit_headers=...): # -> None:
    r'''
