...
def disable(fn=..., recursive=..., *, reason=...): # -> OptimizedModule | type[Module] | type[Any] | _Wrapped[Callable[..., Any], object, Callable[..., Any], object] | Callable[..., object] | DisableContext | Callable[..., Callable[..., object]]:
    """
...
def set_stance(stance: str = ..., *, skip_guard_eval_unsafe=..., force_backend=...): # -> set_stance:
    """
