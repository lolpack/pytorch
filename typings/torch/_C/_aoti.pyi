...
class AOTIModelContainerRunner(Protocol):
    ...
    def update_constant_buffer(self, tensor_map: dict[str, Tensor], use_inactive: bool, validate_full_updates: bool, user_managed: bool = ...) -> None:
        ...
...
class AOTIModelPackageLoader:
    def __init__(self, model_package_path: str, model_name: str, run_single_threaded: bool, num_runners: int, device_index: int) -> None:
        ...
    ...
    def load_constants(self, constants_map: dict[str, Tensor], use_inactive: bool, check_full_update: bool, user_managed: bool = ...) -> None:
        ...
