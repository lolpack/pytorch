...
class Property(TreeView):
    def __init__(self, r: SourceRange, name: Ident, getter: Def, setter: Optional[Def]) -> None:
        ...
...
class Decl(TreeView):
    def __init__(self, r: SourceRange, params: list[Param], return_type: Optional[Expr]) -> None:
        ...
...
class WithItem(Expr):
    def __init__(self, range: SourceRange, target: Expr, var: Optional[Any]) -> None:
        ...
    


class Assign(Stmt):
    def __init__(self, lhs: list[Expr], rhs: Expr, type: Optional[Expr] = ...) -> None:
        ...
...
class SliceExpr(Expr):
    def __init__(self, range: SourceRange, lower: Optional[Expr], upper: Optional[Expr], step: Optional[Expr]) -> None:
        ...
