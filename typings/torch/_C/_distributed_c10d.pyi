...
class Reducer:
    def __init__(self, params: list[Tensor], bucket_indices: list[list[int]], per_bucket_size_limits: list[int], process_group: ProcessGroup, expect_sparse_gradients: list[bool] = ..., bucket_bytes_cap: int = ..., find_unused_parameters: bool = ..., gradient_as_bucket_view: bool = ..., param_to_name_mapping: dict[int, str] = ..., first_bucket_types_cap: int = ..., skip_all_reduce_unused_params: bool = ..., use_python_reducer: bool = ...) -> None:
        ...
...
class Logger:
    ...
    def set_construction_data_and_log(self, module_name: str, device_ids: list[int], output_device: int, broadcast_buffers: bool, has_sync_bn: bool, static_graph: bool):
        ...
...
class ProcessGroup:
    ...
    @overload
    def broadcast(self, tensor: Tensor, root: int) -> Work:
        ...
    ...
    @overload
    def allreduce(self, tensors: list[Tensor], op=...) -> Work:
        ...
    
    @overload
    def allreduce(self, tensor: Tensor, op=...) -> Work:
        ...
    ...
    @overload
    def reduce(self, tensor: Tensor, root: int, op=...) -> Work:
        ...
    ...
    @overload
    def allgather(self, output_tensors: list[Tensor], input_tensor: Tensor) -> Work:
        ...
    ...
    @overload
    def gather(self, output_tensors: list[Tensor], input_tensor: Tensor, root: int) -> Work:
        ...
    ...
    @overload
    def scatter(self, output_tensor: Tensor, input_tensors: list[Tensor], root: int) -> Work:
        ...
    ...
    @overload
    def reduce_scatter(self, output_tensors: Tensor, input_tensor: list[Tensor]) -> Work:
        ...
    ...
    @overload
    def alltoall_base(self, output: Tensor, input: Tensor, output_split_sizes: list[int], input_split_sizes: list[int]) -> Work:
        ...
    ...
    @overload
    def alltoall(self, output: list[Tensor], input: list[Tensor]) -> Work:
        ...
