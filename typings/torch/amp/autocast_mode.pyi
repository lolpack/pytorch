...
def autocast_decorator(autocast_instance, func): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    ...
...
def custom_fwd(fwd=..., *, device_type: str, cast_inputs: Optional[_dtype] = ...): # -> partial[Any] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """
...
def custom_bwd(bwd=..., *, device_type: str): # -> partial[Any] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
