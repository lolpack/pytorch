...
log = ...
@overload
def custom_op(name: str, fn: Literal[None] = ..., /, *, mutates_args: Union[str, Iterable[str]], device_types: device_types_t = ..., schema: Optional[str] = ...) -> Callable[[Callable[..., object]], CustomOpDef]:
    ...

@overload
def custom_op(name: str, fn: Callable[..., object], /, *, mutates_args: Union[str, Iterable[str]], device_types: device_types_t = ..., schema: Optional[str] = ...) -> CustomOpDef:
    ...
