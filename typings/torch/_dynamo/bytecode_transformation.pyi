...
if sys.version_info >= (3, 12):
    ...
    ...
def create_instruction(name, *, arg=..., argval=..., target=...) -> Instruction:
    """
...
def create_load_const(val, checked=...) -> Instruction:
    """
...
def linetable_311_writer(first_lineno: int): # -> tuple[list[Any], Callable[..., None]]:
    """
    Used to create typing.CodeType.co_linetable
    See https://github.com/python/cpython/blob/3.11/Objects/locations.md
...
def transform_code_object(code, transformations, safe=...) -> types.CodeType:
    ...
...
def cleaned_instructions(code, safe=...) -> list[Instruction]:
    ...

_unique_id_counter = ...
def unique_id(name, with_uuid=...) -> str:
    ...

def is_generator(code: types.CodeType) -> bool:
    ...

def bytecode_from_template(fn, varname_map=..., noreturn=..., noprefix=...): # -> list[DataclassInstance]:
