...
class SubmodCompiler(torch.fx.interpreter.Interpreter):
    ...
    def compile_submod(self, input_mod, args, kwargs): # -> WrapperModule:
        """
...
class DDPOptimizer:
    ...
    """
    def __init__(self, bucket_bytes_cap: int, backend_compile_fn, first_bucket_cap: Optional[int] = ...) -> None:
        ...
