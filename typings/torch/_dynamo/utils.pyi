...
def tabulate(rows: Union[list[tuple[str, object]], list[list[object]]], headers: Union[tuple[str, ...], list[str]]) -> str:
    ...
...
def compile_times(repr=..., aggregate: bool = ...): # -> str | tuple[list[str], list[str | Any]] | None:
    """
...
def setup_compile_debug(): # -> ExitStack[bool | None]:
    ...

def reset_graph_break_dup_checker() -> None:
    ...

def add_file_handler(): # -> ExitStack[bool | None]:
    ...

def setup_log_file(): # -> ExitStack[bool | None]:
    ...
...
def istype(obj, allowed_types): # -> bool:
...
def unwrap_if_wrapper(fn): # -> Any | FunctionType | BuiltinFunctionType | MethodDescriptorType | WrapperDescriptorType:
    ...

def unwrap_with_attr_name_if_wrapper(fn): # -> tuple[Any | FunctionType | BuiltinFunctionType | MethodDescriptorType | WrapperDescriptorType, Literal['_torchdynamo_inline'] | None]:
    ...

def is_numpy_ndarray(value): # -> bool:
    ...

def istensor(obj): # -> bool:
...
def make_cell(val=...): # -> CellType:
    """Some black magic to create a cell object that usually only exists in a closure"""
    ...

def proxy_args_kwargs(args, kwargs): # -> tuple[tuple[Any, ...], dict[Any, Any]]:
    ...
...
class CompilationMetrics:
    ...
    @classmethod
    def create(cls, metrics: dict[str, Any]): # -> Self:
        """
...
class ChromiumEventLogger:
    ...
    def get_pt2_compile_substack(self): # -> Any | list[Any]:
        """
...
class CleanupHook:
    ...
    @staticmethod
    def create(scope, name, val): # -> CleanupHook:
        ...
...
def clone_input(x, *, dtype=...): # -> Tensor:
    """copy while preserving strides"""
    ...

def clone_inputs(example_inputs): # -> dict[Any, Any] | list[Any]:
    ...
...
@contextmanager
def preserve_rng_state(): # -> Generator[None, Any, None]:
    ...

def is_jit_model(model0): # -> bool:
    ...

def torchscript(model, example_inputs, verbose=...): # -> ScriptModule | TopLevelTracedModule | tuple[Graph, Stack] | None:
    ...
...
def checkpoint_params(gm): # -> Callable[[], None]:
    ...

def timed(model, example_inputs, times=...): # -> tuple[Any, float]:
    ...

def check_is_cuda(gm, example_inputs): # -> bool:
    ...

@lru_cache(32)
def rot_n_helper(n): # -> Any:
    ...
...
def specialize_symnode(arg): # -> LazyVariableTracker | VariableTracker:
    ...

def guard_if_dyn(arg): # -> Any | LazyVariableTracker | VariableTracker:
    ...

def check_constant_args(args, kwargs): # -> bool:
    ...

def check_unspec_python_args(args, kwargs): # -> bool:
    ...

def check_unspec_or_constant_args(args, kwargs): # -> bool:
    ...

def check_numpy_ndarray_args(args, kwargs): # -> bool:
    ...
...
list_getitem = ...
str_methods = ...
def builtin_dict_keys(d): # -> dict_keys[Any, Any]:
    ...

def get_items_from_dict(obj): # -> dict_items[Any, Any] | list[tuple[Any, Any]]:
    ...
...
def enum_repr(value, local): # -> str:
    ...

def set_example_value(node, example_value): # -> None:
    ...

def iter_contains(items, search, tx, check_tensor_identity=...): # -> VariableTracker:
    ...
...
def key_to_id(value): # -> list[int | Any]:
    ...
...
def get_unique_name_wrt(prefix: str, *containers, requires_suffix=...) -> str:
    """
...
def rmse(ref, res): # -> Tensor:
    """
    Calculate root mean squared error
    """
    ...

def same(ref, res, fp64_ref=..., cos_similarity=..., tol=..., equal_nan=..., exact_dtype=..., relax_numpy_equality=..., ignore_non_fp=..., log_error=..., use_larger_multiplier_for_smaller_tensor=..., force_max_multiplier: bool = ...): # -> bool:
...
def disable_cache_limit(): # -> Generator[None, Any, None]:
    ...
...
def extract_fake_example_value(node, required=...): # -> None:
    ...
...
def get_fake_value(node, tx, allow_non_graph_fake=...):
    """
...
_current_node = ...
def get_current_node(): # -> Any | None:
    ...

@contextmanager
def set_current_node(node): # -> Generator[None, Any, None]:
    ...
...
def tensor_static_reason_to_message(reason: TensorStaticReason): # -> LiteralString | Literal['mark_dynamic on a non tensor, how did this happen?']:
    ...
...
def lazy_format_graph_tabular(fn_name, gm): # -> LazyString[Callable[[], Any]]:
    ...
...
all_hook_names = ...
def nn_module_has_global_hooks(): # -> int:
    ...

def nn_module_get_all_hooks(mod, check_forward_hooks=..., check_backward_hooks=..., check_state_dict_hooks=...): # -> list[Any]:
    """
...
def nnmodule_has_hooks(mod, check_forward_hooks=..., check_backward_hooks=..., check_state_dict_hooks=...): # -> bool:
    """
    Helper function to check if a module has any hooks attached to it.
    """
    ...

def to_numpy_helper(value): # -> list[Any] | tuple[Any, ...]:
    """Convert tensor and tnp.ndarray to numpy.ndarray."""
    ...

def numpy_to_tensor(value): # -> Tensor | list[Any] | tuple[Any, ...]:
...
class numpy_to_tensor_wrapper:
    ...
    def __call__(self, *args, **kwargs): # -> Tensor | list[Any] | tuple[Any, ...]:
        ...
    


def numpy_attr_wrapper(obj, name): # -> Tensor | list[Any] | tuple[Any, ...] | Any | None:
    ...
...
class numpy_method_wrapper:
    ...
    def __call__(self, *args, **kwargs): # -> Tensor | list[Any] | tuple[Any, ...] | Any:
        ...
...
def build_invoke_subgraph_variable(**options): # -> BaseHOPVariable:
    ...

def build_checkpoint_variable(**options): # -> BaseHOPVariable:
    ...
...
def get_static_address_type(t): # -> Any | None:
    ...
...
def is_frozen_dataclass(value): # -> TypeIs[DataclassInstance | type[DataclassInstance]] | Literal[False]:
    ...

def get_first_attr(obj, *attrs): # -> Any:
    """
...
@contextlib.contextmanager
def maybe_enable_compiled_autograd(should_enable, fullgraph=..., dynamic=...): # -> Generator[Any | None, Any, None]:
    ...
...
def nn_module_proxy(mod): # -> GraphModule | Module:
    ...
...
def flatten_graph_inputs(gm: torch.fx.GraphModule, inputs, compile_gm): # -> Callable[..., Any]:
    """
...
def get_locals_to_steal(maybe_gm): # -> list[Any] | Any:
    ...
...
def warn_once(msg, stacklevel=...): # -> None:
    ...

def strip_color_from_string(text): # -> str:
    ...
...
def get_torch_function_mode_stack_at(ind): # -> Any:
    ...
...
def does_not_override_dict_iter_methods(user_cls): # -> bool:
    ...
...
def get_user_object_from_id(obj_id): # -> object:
    ...
...
class CompileTimeInstructionCounter:
    ...
    @classmethod
    @contextmanager
    def record(cls): # -> Generator[None, Any, None]:
        ...
...
def get_optimize_ddp_mode(): # -> Literal['ddp_optimizer', 'no_optimization', 'python_reducer', 'python_reducer_without_compiled_forward']:
    ...
