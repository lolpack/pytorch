...
class SparseSemiStructuredTensor(torch.Tensor):
    ...
    __slots__ = ...
    @staticmethod
    def __new__(cls, shape: torch.Size, packed: Optional[torch.Tensor], meta: Optional[torch.Tensor], packed_t: Optional[torch.Tensor], meta_t: Optional[torch.Tensor], compressed_swizzled_bitmask: Optional[torch.Tensor], fuse_transpose_cusparselt: bool = ..., alg_id_cusparselt: int = ..., requires_grad: bool = ...):
        """
